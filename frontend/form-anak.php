...
<body>
    <div class="d-flex justify-content-center" style="padding: 40px;">
        <div class="kotak" style="padding: 30px 45px 45px 45px;">
            ...
            <form action="../backend/create-anak.php" method="POST" novalidate>
                ...
                <div class="d-flex gap-4 mt-3">
                    ...
                    <div class="w-50">
                        ...
                        <div class="form-group w-30 text-start mt-2">
                            <label>Gender</label>
                ...
                <div class="d-flex justify-content-center gap-2 mt-3">
                    <button type="submit" class="btn btn-primary mt-3" style="width: 75%;" name="formanak">Daftar Sekarang</button>
